...
function CyberLoadingScreen() {
  return (
    <div style={{
      ...
      background: 'var(--cz-void)', flexDirection: 'column', gap: 28,
      fontFamily: 'var(--font-mono)',
    }}>
      {/* Top hazard stripe */}
      <div style={{ position: 'fixed', top: 0, left: 0, right: 0, height: 3,
        background: 'repeating-linear-gradient(-45deg, var(--cz-orange) 0px, var(--cz-orange) 8px, rgba(0,0,0,0.6) 8px, rgba(0,0,0,0.6) 16px)',
        boxShadow: '0 0 16px rgba(232,89,10,0.8)', zIndex: 1000,
      }} />
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 20 }}>
        ...
        <div style={{
          ...
          boxShadow: '0 0 30px rgba(232,89,10,0.35), inset 0 0 20px rgba(232,89,10,0.05)',
        ...
        <div style={{ textAlign: 'center' }}>
          <p style={{
            ...
            color: 'var(--cz-orange)', textTransform: 'uppercase',
            textShadow: '0 0 20px rgba(232,89,10,0.5)',
            margin: 0, lineHeight: 1,
          }}>CYBER-PONG</p>
          <p style={{
            fontFamily: 'var(--font-mono)', fontSize: '0.58rem', letterSpacing: '0.25em',
            color: 'rgba(232,89,10,0.45)', textTransform: 'uppercase', marginTop: 4,
        ...
        <div style={{
          ...
          {[
            ...
            <p key={i} style={{
              ...
              color: i < 2 ? 'var(--cz-acid)' : 'rgba(127,255,0,0.4)',
        ...
        <div style={{ width: 280, height: 3, background: '#1A1A14', overflow: 'hidden', position: 'relative' }}>
          <div style={{
            height: '100%', width: '35%',
            background: 'linear-gradient(90deg, transparent, var(--cz-orange), var(--cz-orange))',
            boxShadow: '0 0 10px var(--cz-orange)',
...
function CyberErrorScreen() {
  return (
    <div style={{
      minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center',
      background: 'var(--cz-void)', padding: 24, flexDirection: 'column', gap: 20,
    }}>
      {/* Blood-red hazard stripe */}
      <div style={{ position: 'fixed', top: 0, left: 0, right: 0, height: 3,
        background: 'repeating-linear-gradient(-45deg, var(--cz-blood) 0px, var(--cz-blood) 8px, rgba(0,0,0,0.6) 8px, rgba(0,0,0,0.6) 16px)',
        boxShadow: '0 0 16px rgba(204,0,28,0.8)', zIndex: 1000,
      }} />

      <div style={{
        padding: '28px 24px', textAlign: 'center', maxWidth: 380, width: '100%',
        background: '#0D0008',
        border: '1px solid rgba(204,0,28,0.45)',
        clipPath: 'polygon(0 0, calc(100% - 18px) 0, 100% 18px, 100% 100%, 18px 100%, 0 calc(100% - 18px))',
        boxShadow: '0 0 40px rgba(204,0,28,0.2), inset 0 0 30px rgba(204,0,28,0.04)',
        position: 'relative', overflow: 'hidden',
        animation: 'neon-blood 2s ease-in-out infinite',
      }}>
        {/* Scanlines */}
        <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ fontSize: '2.8rem', marginBottom: 14, filter: 'drop-shadow(0 0 8px rgba(204,0,28,0.6))' }}>☠</div>
          <p style={{ fontFamily: 'var(--font-display)', fontSize: '1.4rem', letterSpacing: '0.12em', color: 'var(--cz-blood)', marginBottom: 6, textTransform: 'uppercase',
            textShadow: '0 0 16px rgba(204,0,28,0.6)',
          }}>
            CONNECTION FAILURE
          </p>
          <div style={{
            padding: '10px 12px', background: 'rgba(204,0,28,0.06)',
            border: '1px solid rgba(204,0,28,0.2)', marginBottom: 20,
            clipPath: 'polygon(4px 0, 100% 0, calc(100% - 4px) 100%, 0 100%)',
          }}>
            <p style={{ fontFamily: 'var(--font-mono)', fontSize: '0.65rem', color: 'var(--cz-dim)', letterSpacing: '0.06em', lineHeight: 1.7 }}>
      ...
      >
        ...
        <div aria-hidden="true" style={{
          ...
          <div style={{
            ...
            background: 'radial-gradient(ellipse at center top, rgba(232,89,10,0.08) 0%, rgba(180,55,0,0.03) 45%, transparent 72%)',
          }} />
          {/* Secondary warm glow — bottom-left */}
          <div style={{
            position: 'absolute', bottom: '-10%', left: '-5%',
            width: '55vw', height: '55vh',
            background: 'radial-gradient(ellipse at bottom left, rgba(204,0,28,0.04) 0%, transparent 65%)',
          }} />
          {/* Acid accent — mid right */}
          <div style={{
            position: 'absolute', top: '40%', right: '-5%',
            width: '35vw', height: '40vh',
            background: 'radial-gradient(ellipse at right center, rgba(127,255,0,0.02) 0%, transparent 60%)',
          }} />
          {/* Fine dot grid */}
          <div style={{
            position: 'absolute', inset: 0,
            backgroundImage: 'radial-gradient(circle at 1px 1px, rgba(232,89,10,0.07) 1px, transparent 0)',
          ...
          <div style={{
            ...
            height: '1px',
            background: 'linear-gradient(90deg, transparent 0%, rgba(232,89,10,0.06) 20%, rgba(232,89,10,0.12) 50%, rgba(232,89,10,0.06) 80%, transparent 100%)',
          }} />
          {/* Coarse grid overlay */}
          <div style={{
            position: 'absolute', inset: 0,
            backgroundImage: `
              linear-gradient(rgba(232,89,10,0.025) 1px, transparent 1px),
              linear-gradient(90deg, rgba(232,89,10,0.025) 1px, transparent 1px)
            `,
          ...
          <div style={{
            ...
            background: 'linear-gradient(to top, rgba(232,89,10,0.03) 0%, transparent 100%)',
          }} />
          {/* Vertical side accent lines */}
          <div style={{
            position: 'absolute', top: 0, bottom: 0, left: 0, width: '1px',
            background: 'linear-gradient(to bottom, rgba(232,89,10,0.15) 0%, transparent 40%)',
          }} />
          <div style={{
