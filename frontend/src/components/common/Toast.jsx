...
const STYLES = {
  success: {
    ...
    accent:   'var(--sw-settled)',
    icon:     <CheckCircle2 size={16} style={{ color: 'var(--sw-settled)', flexShrink: 0 }} />,
    prefix:   'OK',
  },
  error: {
    bg:       '#0e0606',
    border:   'rgba(139,130,204,0.4)',
    shadow:   '0 0 20px rgba(139,130,204,0.12)',
    accent:   'var(--sw-pending)',
    icon:     <AlertCircle size={16} style={{ color: 'var(--sw-pending)', flexShrink: 0 }} />,
    prefix:   'ERR',
  },
  info: {
    bg:       '#080808',
    border:   'rgba(255,0,255,0.25)',
    shadow:   '0 0 16px rgba(255,0,255,0.06)',
    accent:   'var(--sw-pink)',
    icon:     <Terminal size={16} style={{ color: 'var(--sw-pink)', flexShrink: 0 }} />,
    prefix:   'SYS',
  },
};
