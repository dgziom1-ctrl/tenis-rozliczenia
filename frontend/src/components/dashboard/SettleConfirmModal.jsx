  ...
  return (
    ...
    >
      <div style={{
        ...
        boxShadow: '0 0 50px rgba(255,0,255,0.15), 0 4px 60px rgba(0,0,0,0.95)',
        padding: '26px 22px', width: '100%', maxWidth: 380,
      }}>
        {/* Yellow corner accent */}
        <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: 2, background: 'linear-gradient(90deg, var(--sw-pink), transparent)', opacity: 0.6 }} />
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
          <div style={{
            ...
            <HandCoins size={18} style={{ color: 'var(--sw-pink)' }} />
          </div>
          <div>
            <p style={{ fontFamily: 'var(--font-display)', fontSize: '0.85rem', letterSpacing: '0.12em', color: 'var(--sw-pink)', opacity: 0.7, marginBottom: 3, textTransform: 'uppercase' }}>
