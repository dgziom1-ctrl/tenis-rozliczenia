  ...
  return (
    <div style={{ marginBottom: 12 }}>
      <button onClick={onToggle} style={{
        ...
        letterSpacing: '0.14em', color: 'rgba(129,140,248,0.5)', textTransform: 'uppercase',
      }}
        onMouseEnter={e => { e.currentTarget.style.borderColor = 'rgba(129,140,248,0.25)'; e.currentTarget.style.color = 'var(--cyber-accent)'; }}
        onMouseLeave={e => { e.currentTarget.style.borderColor = '#1a1a1a'; e.currentTarget.style.color = 'rgba(129,140,248,0.5)'; }}
      >
          ...
          {breakdown.payments.length > 0 && (
            <>
              ...
              {breakdown.payments.map((item, idx) => (
                <TerminalRow key={idx}>
                  ...
                  <span style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                    <span style={{ fontFamily: 'var(--font-mono)', fontSize: '0.7rem', color: 'var(--cyber-accent)', fontWeight: 600 }}>
                      +{formatAmountShort(item.amount)} ZŁ
                    </span>
              ...
              {breakdown.payments.length > 1 && (
                <TerminalRow highlight="rgba(129,140,248,0.03)">
                  ...
                  <span style={{ fontFamily: 'var(--font-mono)', fontSize: '0.7rem', color: 'var(--cyber-accent)' }}>
          ...
          <div style={{
            ...
            <span style={{
              ...
              color: breakdown.balance > 0.01 ? 'var(--cyber-red)'
                   : breakdown.balance < -0.01 ? 'var(--cyber-accent)'
                   : 'var(--cyber-green)',
            }}>
