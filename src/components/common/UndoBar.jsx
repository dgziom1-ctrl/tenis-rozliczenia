...
export default function UndoBar({ message, secondsLeft, progressPct, onUndo, buttonLabel = 'COFNIJ', compact = false }) {
  ...
  return (
    <div style={{
      ...
      boxShadow: compact ? 'none' : '0 0 16px rgba(232,89,10,0.08)',
      clipPath: compact
      ...
      <div style={{
        ...
        boxShadow: '0 0 6px var(--cz-orange)',
      ...
      <button onClick={onUndo} style={{
        ...
        onMouseEnter={e => { e.currentTarget.style.background = 'rgba(232,89,10,0.08)'; e.currentTarget.style.borderColor = 'var(--cz-orange)'; }}
