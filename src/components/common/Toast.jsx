...
const STYLES = {
  success: {
    bg:       '#060e06',
    border:   'rgba(127,255,0,0.35)',
    shadow:   '0 0 20px rgba(127,255,0,0.1)',
    accent:   'var(--cz-acid)',
    icon:     <CheckCircle2 size={16} style={{ color: 'var(--cz-acid)', flexShrink: 0 }} />,
    prefix:   'OK',
  },
  error: {
    bg:       '#0e0606',
    border:   'rgba(255,0,51,0.4)',
    shadow:   '0 0 20px rgba(255,0,51,0.12)',
    accent:   'var(--cz-blood)',
    icon:     <AlertCircle size={16} style={{ color: 'var(--cz-blood)', flexShrink: 0 }} />,
    prefix:   'ERR',
  },
  info: {
    bg:       '#080808',
    border:   'rgba(232,89,10,0.25)',
    shadow:   '0 0 16px rgba(232,89,10,0.06)',
    accent:   'var(--cz-orange)',
    icon:     <Terminal size={16} style={{ color: 'var(--cz-orange)', flexShrink: 0 }} />,
    prefix:   'SYS',
  },
};
