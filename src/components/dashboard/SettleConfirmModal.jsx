  ...
  return (
    ...
    >
      <div style={{
        ...
        boxShadow: '0 0 50px rgba(232,89,10,0.15), 0 4px 60px rgba(0,0,0,0.95)',
        padding: '26px 22px', width: '100%', maxWidth: 380,
      }}>
        {/* Yellow corner accent */}
        <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: 2, background: 'linear-gradient(90deg, var(--cz-orange), transparent)', opacity: 0.6 }} />

        {/* Header */}
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
          <div style={{
            width: 40, height: 40,
            background: 'rgba(232,89,10,0.07)',
            border: '1px solid rgba(232,89,10,0.35)',
            clipPath: 'polygon(0 0, calc(100% - 8px) 0, 100% 8px, 100% 100%, 8px 100%, 0 calc(100% - 8px))',
            display: 'flex', alignItems: 'center', justifyContent: 'center',
          }}>
            <HandCoins size={18} style={{ color: 'var(--cz-orange)' }} />
          </div>
          <div>
            <p style={{ fontFamily: 'var(--font-display)', fontSize: '0.85rem', letterSpacing: '0.12em', color: 'var(--cz-orange)', opacity: 0.7, marginBottom: 3, textTransform: 'uppercase' }}>
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          <div style={{
            ...
            <span style={{
              ...
              color: 'var(--cz-orange)',
              textShadow: '0 0 20px rgba(232,89,10,0.4)',
            }}>
